...
namespace IdentityExample.Data.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "Address", "Contact", "DateOfBirth", "Email", "FirstName", "LastName", "MiddleName", "PositionId" },
                values: new object[,]
                {
                    { 1, "Kathmandu", "9843710782", new DateOnly(1996, 11, 25), "nitesh.shresthax@gmail.com", "Nitesh", "Shrestha", "", 1 },
                    { 2, "Kathmandu", "9849019203", new DateOnly(1995, 3, 15), "aayush.malakar@gmail.com", "Aayush", "Malakar", "", 1 }
                });
